...
///
/// ```ignore
/// $ jq -C . ~/.aren/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// $ fx ~/.aren/sessions/rollout-2025-05-07T17-24-21-5973b6c0-94b8-487b-a530-2aeb6098ae0e.jsonl
/// ```
#[derive(Clone)]
...
fn precompute_log_file_info(
    ...
    // Resolve ~/.aren/sessions/YYYY/MM/DD path.
